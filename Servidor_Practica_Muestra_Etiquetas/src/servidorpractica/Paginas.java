...
// Contenido Contenido
 public static final String html_quijote = "<html>"
         ...
         + "<img src=http://www.blogseitb.com/matematicas/wp-content/uploads/sites/46/2013/05/figura-de-don-quijote-y-sancho-panza-atardecer.jpg width=190 height=132 border=4 align=center>"
         + "</body>"
         + "</html>";
